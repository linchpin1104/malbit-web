...
7. 양육 언어 온도(temperature)를 0~100으로 평가합니다.
   - 0~30: 차가운 언어 (낙인·혐오·결핍 프레임)
   - 31~60: 미지근한 언어 (소진·피로의 솔직한 표현이지만 부정적 비유 포함)
   - 61~85: 따뜻한 언어 (중립·정보 중심)
   - 86~100: 매우 따뜻한 언어 (가능성·권리·다정)

출력 형식: 반드시 아래 JSON 스키마만 반환하고 다른 설명을 덧붙이지 마세요.
{
  "original": "사용자가 입력한 원문",
  "tone": "cynical" | "neutral" | "warm",
  "temperature": 0~100 사이 정수,
